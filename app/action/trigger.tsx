...
export default function Trigger() {
    ...
    return (
        <div className="flex flex-col mt-10 w-full justify-center items-center">
            <button className="flex items-center justify-center text-4xl h-12 w-60 bg-black shadow-lg shadow-red-600 hover:shadow-xl disabled:bg-green-400 rounded-xl text-black dark:text-white" onClick={trigger} disabled={loading}>{loading ? <LoadingCircle width="10" height="10"/> : "TRIGGER IT"}</button>
