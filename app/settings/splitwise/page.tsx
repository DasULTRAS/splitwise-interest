...
export default function SplitwiseSettings() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (response.ok) setMessage("Data saved successfully");
    else {
      const data = await response.json();
  ...
  return (
    <div className="m-3 flex w-full flex-col items-center sm:m-5">
      <h1 className="mb-5 text-center">Splitwise Credentials</h1>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm lg:max-w-3xl">
        ...
        <div className="flex w-full justify-center">
          <button className="btn_save flex" type="submit" disabled={loading || !consumerKey || !consumerSecret}>
      ...
      <section id="setup-splitwise">
        <h2 className="mb-3 text-center">
          <a className="a_link" href="https://secure.splitwise.com/oauth_clients" target="_blank" rel="noopener">
            Where to find this Credentials?
          </a>
        </h2>
        <p className="mb-3 text-center">
          ...
          in your{" "}
          <a className="a_link" href="https://splitwise.com" target="_blank" rel="noopener">
            Splitwise
          </a>{" "}
          account.
          <br />
        ...
        <ol type="1" className="mr-5 list-inside list-decimal space-y-3">
          ...
          <li>
            Open the{" "}
            <a className="a_link" href="https://secure.splitwise.com/apps" target="_blank" rel="noopener">
              &quot;Your apps&quot;
            </a>{" "}
            Site by
            <ol type="a" className="ml-5 list-inside list-[lower-alpha]">
              ...
              <li>
                ...
                <a
                  className="a_link"
                  href="https://secure.splitwise.com/account/settings"
                  target="_blank"
                  rel="noopener"
                >
                  &quot;Your account&quot;
