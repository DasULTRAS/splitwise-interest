...
export default function PasswordChangeForm() {
  ...
  return (
    <div className="mx-5 mt-5 w-full">
      ...
      <form className="rounded pb-8 pt-6" onSubmit={handleSubmit}>
        <div className="mb-4 w-full md:mx-auto md:flex md:max-w-3xl">
          <InputPassword
            label="Password"
            className="mb-4 w-full md:mb-0 md:mr-2 md:w-1/2"
            value={password}
